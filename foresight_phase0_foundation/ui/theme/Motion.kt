...
/**
 * Shared motion tokens so every screen animates with the same feel instead of
 * ad-hoc durations. Values follow Material Motion's "emphasized" easing guidance,
 * tuned down slightly for a snappier fintech feel.
 */
object Motion {
