...
/**
 * UI-only presentation mapping for risk levels: color + icon + label.
 * Reads the SAME risk category strings the AI Risk Engine already returns
 * ("safe"/"low"/"medium"/"warning"/"high"/"critical") — does not change,
 * re-score, or reinterpret any risk decision.
 */
